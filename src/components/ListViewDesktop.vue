<template>  
    ...
    <div class="list-view">
        ...
        <template v-if="categoryIndex != -1 && store.state.store.categories[categoryIndex] && store.state.store.categories[categoryIndex].items">
          <StoreItem layout="list" :item="item" v-for="(item, itemIndex) of store.state.store.categories[categoryIndex].items" 
              :key="itemIndex">
          </StoreItem>
        </template>

        <template v-if="categoryIndex == -1">
          <StoreItem layout="list" :item="item" v-for="(item, itemIndex) of props.items" 
              :key="itemIndex">
          </StoreItem>
        </template>
